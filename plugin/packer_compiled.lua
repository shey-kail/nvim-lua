...
_G.packer_plugins = {
  ...
  ["nvim-colorizer.lua"] = {
    loaded = true,
    path = "/home/shey/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
